...
## Объектно-ориентированное программирование: Named tuple, staticmethod, classmethod, property
...
Метод класса - это метод, который привязан к классу, а не к экземпляру.

Чаще всего, такие методы используются как альтернативные конструкторы экземпляров, а также в ситуации, когда один статический метод должен вызвать другой.
