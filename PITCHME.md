...
* [Geany](https://www.geany.org/) - текстовый редактор
...
* pyneng-6-lectures - обсуждение и вопросы во время лекций
* pyneng-6-work - тут будут те обсуждения, которые касаются лекций, заданий и других вопросов курса
* pyneng-6-talk - тут можно говорить о чем угодно
